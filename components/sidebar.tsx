...
import { FileText, Settings, Home, Activity, Briefcase, AmbulanceIcon as FirstAid, Mic } from "lucide-react"
          ...
          <SidebarGroupContent>
            <SidebarMenu>
              ...
              <SidebarMenuItem>
                <SidebarMenuButton asChild>
                  <Link
                    href="/voice-clone-translate"
                    className="flex items-center text-muted-foreground hover:text-primary"
                  >
                    <Mic className="mr-2 h-4 w-4" />
                    <span>Voice Clone & Translate</span>
                  </Link>
                </SidebarMenuButton>
              </SidebarMenuItem>
              <SidebarMenuItem>
